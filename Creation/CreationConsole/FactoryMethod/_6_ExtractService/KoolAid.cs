namespace CreationConsole.FactoryMethod.ExtractService
{
	using System;
	...
	public class Test
	{
		public void Create_using_new()
		{
			...
			var koolAidMaker = new LowCostKoolAidMaker(koolAidFactory);

			var beverageStand = new BeverageStand(koolAidMaker);
